...
public abstract class ClassUtils {
	...
	public static boolean matchesTypeName(Class<?> clazz, String typeName) {
		return (typeName != null && (typeName.equals(clazz.getName())
				|| typeName.equals(clazz.getSimpleName()) || (clazz.isArray()
	...
	public static Method getMethod(Class<?> clazz, String methodName,
		...
		if (paramTypes != null) {
			...
			if (candidates.size() == 1) {
				...
				throw new IllegalStateException(
						"No unique method found: " + clazz + "." + methodName);
			}
		}
	}
	...
	private static boolean isOverridable(Method method, Class<?> targetClass) {
		...
		return getPackageName(method.getDeclaringClass())
	...
	public static Set<Class> getAllInterfacesForClassAsSet(Class clazz,
		...
		while (clazz != null) {
			...
			for (Class<?> ifc : ifcs) {
				interfaces.addAll(
						getAllInterfacesForClassAsSet(ifc, classLoader));
			}
