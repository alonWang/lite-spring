...
public class BeanDefinitionReaderUtils {
	 ...
	 * 
	 * @param definition
	 *            the bean definition to generate a bean name for
	 * @param registry
	 *            the bean factory that the definition is going to be registered
	 *            with (to check for existing bean names)
	 * @param isInnerBean
	 *            whether the given bean definition will be registered as inner
	 *            bean or as top-level bean (allowing for special name
	 *            generation for inner beans versus top-level beans)
	 * @return the generated bean name
	 * @throws BeanDefinitionStoreException
	 *             if no unique name can be generated for the given bean
	 *             definition
	 */
	...
	/**
	 * Generate a bean name for the given top-level bean definition, unique
	 * within the given bean factory.
	 * 
	...
	/**
	 * Register the given bean definition with a generated name, unique within
